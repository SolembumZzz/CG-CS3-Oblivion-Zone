...
<%@ include file="/admin/layout/script/izi-toasts-add-success.jsp" %>
...
<!--Form Wizard-->
<script src="${pageContext.request.contextPath}/admin/assets/libs/jquery-steps/jquery.steps.min.js"></script>
<script src="${pageContext.request.contextPath}/admin/assets/libs/jquery-validation/jquery.validate.min.js"></script>

<!-- Validation init js-->
<script src="${pageContext.request.contextPath}/admin/assets/js/pages/form-wizard.init.js"></script>
